...
import * as aiFeaturesModule from "./ai_features.js?v=9.0";
import "./ui_features.js?v=9.0"; // HMR tracking: UI event rebinding without full reload
import "./js/server-manager.js?v=9.0"; // Backend Server Manager
import "./js/settings-backup.js?v=9.0"; // Settings export/import
