...
import * as aiFeaturesModule from "./ai_features.js?v=8.9";
import "./ui_features.js?v=8.9"; // HMR tracking: UI event rebinding without full reload
import "./js/server-manager.js?v=8.9"; // Backend Server Manager
import "./js/settings-backup.js?v=8.9"; // Settings export/import
