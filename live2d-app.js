...
import * as aiFeaturesModule from "./ai_features.js?v=8.5";
import "./ui_features.js?v=8.5"; // HMR tracking: UI event rebinding without full reload
import "./js/server-manager.js?v=8.5"; // Backend Server Manager
import "./js/settings-backup.js?v=8.5"; // Settings export/import
